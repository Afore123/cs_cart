<div class="control-group">
    <label class="control-label" for="Merchant_login">{__("Merchant_login")}:</label>
    <div class="controls">
        <input type="text" name="payment_data[processor_params][Merchant_login]" id="Merchant_login" value="{$processor_params.Merchant_login}" >
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="payment_data[processor_params][APIKey]" id="APIKey" value="{$processor_params.APIKey}" >
    </div>
</div>
